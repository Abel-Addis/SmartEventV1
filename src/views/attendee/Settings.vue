  ...
  <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
    ...
    <div class="lg:col-span-3">
      ...
      <div v-if="activeSection === 'Profile'" class="space-y-6">
        <div class="card">
          <h3 class="text-h3 font-bold mb-6">Profile Information</h3>
          <div class="space-y-4">
            <div>
              <label class="block text-sm font-medium mb-2">Full Name</label>
              <input v-model="profile.name" type="text" class="input-field w-full" />
            </div>
            <div>
              <label class="block text-sm font-medium mb-2">Email Address</label>
              <input v-model="profile.email" type="email" class="input-field w-full" />
            </div>
            <div>
              <label class="block text-sm font-medium mb-2">Phone Number</label>
              <input v-model="profile.phone" type="tel" class="input-field w-full" />
            </div>
            <div>
              <label class="block text-sm font-medium mb-2">Bio</label>
              <textarea v-model="profile.bio" rows="4" class="input-field w-full"></textarea>
            </div>
      ...
      <div v-if="activeSection === 'Password'" class="space-y-6">
        <div class="card">
          <h3 class="text-h3 font-bold mb-6">Change Password</h3>
          <div class="space-y-4">
            <div>
            ...
            <button class="btn-primary py-3 px-6">Update Password</button>
          </div>
        </div>
      </div>
        ...
        <div class="card">
          ...
          <div class="space-y-4">
            <label class="flex items-center justify-between cursor-pointer p-3 hover:bg-muted rounded-lg transition-colors">
              ...
              <input v-model="settings.recommendations" type="checkbox" class="rounded" />
            </label>
            <label class="flex items-center justify-between cursor-pointer p-3 hover:bg-muted rounded-lg transition-colors">
              <div>
              ...
              <input v-model="settings.reminders" type="checkbox" class="rounded" />
            </label>
            <label class="flex items-center justify-between cursor-pointer p-3 hover:bg-muted rounded-lg transition-colors">
              <div>
              ...
              <input v-model="settings.promotions" type="checkbox" class="rounded" />
            </label>
            <label class="flex items-center justify-between cursor-pointer p-3 hover:bg-muted rounded-lg transition-colors">
              <div>
              ...
              <input v-model="settings.updates" type="checkbox" class="rounded" />
            </label>
          </div>
        </div>
      </div>
      ...
      <div v-if="activeSection === 'Preferences'" class="space-y-4">
        <div class="card">
          <h3 class="text-h3 font-bold mb-6">Event Preferences</h3>
          <div class="space-y-4">
            <div>
              <label class="block text-sm font-medium mb-3">Favorite Categories</label>
              <div class="flex flex-wrap gap-2">
                <button v-for="cat in ['Music', 'Tech', 'Sports', 'Business', 'Arts', 'Food']" :key="cat" :class="['px-3 py-1.5 rounded-full text-sm font-medium transition-colors', preferences.categories.includes(cat) ? 'bg-primary text-primary-foreground' : 'bg-muted text-muted-foreground hover:bg-muted/80']" @click="toggleCategory(cat)">
                  {{ cat }}
                </button>
              </div>
            </div>
            <div>
              ...
              <input v-model="preferences.location" type="text" placeholder="City or region" class="input-field w-full" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div v-if="activeSection === 'Privacy'" class="space-y-4">
        <div class="card">
          <h3 class="text-h3 font-bold mb-6">Privacy & Security</h3>
          <div class="space-y-4">
            <label class="flex items-center justify-between cursor-pointer p-3 hover:bg-muted rounded-lg transition-colors">
              <div>
              ...
              <input v-model="privacy.publicProfile" type="checkbox" class="rounded" />
            </label>
            <label class="flex items-center justify-between cursor-pointer p-3 hover:bg-muted rounded-lg transition-colors">
              <div>
              ...
              <input v-model="privacy.showAttended" type="checkbox" class="rounded" />
            </label>
            <label class="flex items-center justify-between cursor-pointer p-3 hover:bg-muted rounded-lg transition-colors">
              <div>
              ...
              <input v-model="privacy.twoFactor" type="checkbox" class="rounded" />
            </label>
          </div>
        </div>
      </div>
      ...
      <div v-if="activeSection === 'Account'" class="space-y-4">
        <div class="card border-destructive/20">
          <h3 class="text-h3 font-bold mb-4 text-destructive">Danger Zone</h3>
          <div class="space-y-3">
            <button class="btn-outline text-destructive border-destructive/30 hover:bg-destructive/10 w-full py-3">Download Your Data</button>
            <button class="btn-outline text-destructive border-destructive/30 hover:bg-destructive/10 w-full py-3">Delete Account</button>
          </div>
        </div>
      </div>
    </div>
