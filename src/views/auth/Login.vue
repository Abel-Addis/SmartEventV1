  ...
  <div class="min-h-screen flex items-center justify-center bg-background px-4 py-8">
    <div class="w-full max-w-md">
      <div class="text-center mb-8">
        <h1 class="text-h2 font-bold mb-2">Welcome Back</h1>
        <p class="text-muted-foreground">Sign in to your EventHub account</p>
      </div>
      ...
      <form @submit.prevent="handleLogin" class="card space-y-6">
        ...
        <div class="grid grid-cols-2 gap-3">
          <button type="button" class="btn-outline py-2">Google</button>
          <button type="button" class="btn-outline py-2">GitHub</button>
        </div>
